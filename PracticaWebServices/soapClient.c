...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.75 2021-11-08 16:13:12 GMT")
...
{	if (soap_send_conecta4ns__getStatus(soap, soap_endpoint, soap_action, playerName) || soap_recv_conecta4ns__getStatus(soap, status))
		return soap->error;
	return SOAP_OK;
}
...
{	if (soap_send_conecta4ns__insertChip(soap, soap_endpoint, soap_action, playerName, playerMove) || soap_recv_conecta4ns__insertChip(soap, status))
		return soap->error;
	return SOAP_OK;
}
